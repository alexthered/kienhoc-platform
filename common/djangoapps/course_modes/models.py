...
class CourseMode(models.Model):
    ...
    def expiration_datetime(self):
        ...
        if self._expiration_datetime is not None:
            ...
            return course.end - CourseModeAutoExpirationConfiguration.current().time_from_course_end
...
class CourseModeAutoExpirationConfiguration(ConfigurationModel):
    ...
    # other code.
    verification_window_microseconds = models.BigIntegerField(
        # default to 10 days
    ...
    def verification_window(self):
        ...
        return timedelta(microseconds=self.verification_window_microseconds)
    ...
    def verification_window(self, verification_window):
        ...
        self.verification_window_microseconds = int(verification_window.total_seconds() * 1000000)
