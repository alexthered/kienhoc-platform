...
# The dropdown settings should be backwards compatible, so we do not force them to exist.
if 'REGISTRATION_DROPDOWN_LABEL' in ENV_TOKENS:
    REGISTRATION_DROPDOWN_LABEL = ENV_TOKENS.get('REGISTRATION_DROPDOWN_LABEL')

if 'REGISTRATION_DROPDOWN_CHOICES' in ENV_TOKENS:
    REGISTRATION_DROPDOWN_CHOICES = ENV_TOKENS.get('REGISTRATION_DROPDOWN_CHOICES')

if 'REGISTRATION_DROPDOWN_MISSING_ERROR' in ENV_TOKENS:
    ENV_TOKENS.get('REGISTRATION_DROPDOWN_MISSING_ERROR')
